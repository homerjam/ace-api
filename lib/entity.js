...
class Entity {
  ...
  entitySearch (index, query, children, parents, isAuthorised) {
    return new Promise((resolve, reject) => {
      if (query.limit <= 200) {
        this._entitySearch(index, query, children, parents, isAuthorised)
          .then(resolve, reject);
        return;
      }
      ...
      function __entitySearch (bookmark) {
        ...
        this._entitySearch(index, _query, children, parents, isAuthorised)
          .then((result) => {
